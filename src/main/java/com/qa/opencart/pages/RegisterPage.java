...
public class RegisterPage {
	...
	public boolean registerUser(String firstName,String lastName,String email,String telephone,
		...
		eleUtil.waitForElementVisibile(this.firstName, AppConstants.DEFAULT_SHORT_TIME_OUT);
		...
		String successMsg = eleUtil.waitForElementVisibile(registerSuccessMesg, AppConstants.DEFAULT_MEDIUM_TIME_OUT).getText();
		System.out.println("User reg success msg : "+successMsg);
